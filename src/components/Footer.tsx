        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.pinterest.com/human3699/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 flex items-center justify-center text-gray-400 hover:text-[#E60023] hover:border-[#E60023]/30 hover:bg-[#E60023]/10 transition-all" aria-label="Pinterest">
